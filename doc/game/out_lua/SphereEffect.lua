...
function SphereEffectConfig:new(data, path)
    ...
    self.destroySound = u.parseSoundEvent(data.destroySound, path, "destroySound")
    self.destroyScoreEvent = u.parseScoreEventConfig(data.destroyScoreEvent, path, "destroyScoreEvent")
    ...
    self.canBoostCombo = u.parseBoolean(data.canBoostCombo, path, "canBoostCombo")
    self.canBoostChain = u.parseBoolean(data.canBoostChain, path, "canBoostChain")
    self.applyChainMultiplier = u.parseBoolean(data.applyChainMultiplier, path, "applyChainMultiplier")
    self.canKeepCombo = u.parseBoolean(data.canKeepCombo, path, "canKeepCombo")
