...
function ShooterConfig:new(data, path)
    ...
    self.nextBallSprites = {}
    self.nextBallSprites.sprite = u.parseSprite(data.nextBallSprites.sprite, path, "nextBallSprites.sprite")
    self.nextBallSprites.spriteAnimationSpeed = u.parseNumberOpt(data.nextBallSprites.spriteAnimationSpeed, path, "nextBallSprites.spriteAnimationSpeed")
