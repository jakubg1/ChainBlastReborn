...
-- SPECIFIC FUNCTIONS; COPY OVER

---Draws a line on the screen.
---@param p1 Vector2 The first position.
---@param p2 Vector2 The second position.
---@param color Color The line color.
---@param alpha number? The transparency of the line, from 0 to 1. 1 is fully opaque.
---@param width number? The line width.
function _DrawLine(p1, p2, color, alpha, width)
	love.graphics.setColor(color.r, color.g, color.b, alpha or 1)
	love.graphics.setLineWidth(width or 1)
	-- Fix the straight lines being one pixel shorter than they should.
...
---Draws an empty rectangle on the screen.
---@param pos Vector2 The top-left corner position.
---@param size Vector2 The rectangle size.
---@param color Color? The rectangle color.
---@param alpha number? The transparency of the rectangle, from 0 to 1. 1 is fully opaque.
---@param width number? The line width.
function _DrawRect(pos, size, color, alpha, width)
...
---@param color Color? The rectangle color.
---@param alpha number? The transparency of the rectangle, from 0 to 1. 1 is fully opaque.
function _DrawFillRect(pos, size, color, alpha)
	color = color or Color(1, 1, 1)
	love.graphics.setColor(color.r, color.g, color.b, alpha or 1)
